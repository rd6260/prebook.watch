...
const reels: Reel[] = [
  {
    ...
    genre: "",
    releaseLabel: "",
    poster: "https://cdn.jsdelivr.net/gh/rd6260/prebook.watch@main/public/reel_thumbnails/reel-01.jpg",
    duration: "",
    badge: "",
  ...
  },
  {
    ...
    instagramUrl: "https://youtu.be/VWaWgssXl7c?si=DUq4Zwynjv8BRwyj",
  },
  {
    id: "3",
    title: "Bhola Shankar",
    genre: "",
    releaseLabel: "",
    poster: "https://cdn.jsdelivr.net/gh/rd6260/prebook.watch@main/public/reel_thumbnails/reel-02.jpg",
    duration: "",
    badge: "",
    badgeColor: "bg-red-500 text-white",
  ...
  {
    id: "4",
    title: "Team Bindusagar at Lingaraj Temple!",
    genre: "",
    releaseLabel: "",
    poster: "https://cdn.jsdelivr.net/gh/rd6260/prebook.watch@main/public/reel_thumbnails/reel-03.jpg",
    duration: "",
    ...
    >
      ...
      <div className="relative aspect-[2/3] bg-[hsl(181_100%_9%/0.08)]">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-2.5 pb-2.5 pt-6">
          <p className="text-white font-black text-xs leading-tight break-words">{reel.title}</p>
